$(document).ready(function(){
            ...
            function citySearch(city){
                ...
                $.ajax({
                    ...
                    success: function(result,status){
                        $("#weatherIcon").append("<img src = http://openweathermap.org/img/wn/" + result.weather[0].icon + "@2x.png>");
            ...
            function tempIcon(temp){
                if(temp > 100){
                    $("#tempIcon").append("<img src = img/hellahot.jpg>");
                    
                }
                else if(temp < 100 && temp > 79){
                    $("#tempIcon").append("<img src = img/hot.png>");
                }
                else if(temp < 80 && temp > 59){
                    $("#tempIcon").append("<img src = img/nice.png>");
                }
                else if(temp < 60 && temp > 39){
                    $("#tempIcon").append("<img src = img/cool.png>");
                }
                else if(temp < 40 && temp > 0){
                    $("#tempIcon").append("<img src = img/snowing.png>");
                }
                else if(temp < 0){
                    $("#tempIcon").append("<img src = img/hellacold.png>");
                }
